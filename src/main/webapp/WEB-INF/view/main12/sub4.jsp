...
<table>
  ...
  <tr>
    ...
    <td>${productList[0].price *productList[0].quantity} 개</td>
    <td> ${prodcutList[0].quantity eq 0? "재고없음" : ""}</td>
  ...
  <td> ${prodcutList[1].quantity eq 0? "재고없음" : ""}</td>
  <tr>
  ...
  <tr>
    ...
    <td>${productList[2].price *productList[2].quantity} 개</td>
    <td> ${prodcutList[2].quantity eq 0? "재고없음" : ""}</td>
  </tr>
  <tr>
    ...
    <td>${productList[3].price *productList[3].quantity} 개</td>
    <td> ${prodcutList[3].quantity eq 0? "재고없음" : ""}</td>
  </tr>
  </tbody>
